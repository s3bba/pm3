...
const commands = {
  unix: "curl --proto '=https' --tlsv1.2 -LsSf https://github.com/frectonz/pm3/releases/download/0.1.4/pm3-installer.sh | sh",
  windows:
    'powershell -ExecutionPolicy ByPass -c "irm https://github.com/frectonz/pm3/releases/download/0.1.4/pm3-installer.ps1 | iex"',
} as const;
