...
const commands = {
  unix: "curl --proto '=https' --tlsv1.2 -LsSf https://github.com/frectonz/pm3/releases/download/0.1.3/pm3-installer.sh | sh",
  windows:
...
export function InstallCommand() {
  ...
  return (
    <div className="w-full max-w-4xl mb-8 rounded-lg border border-fd-border bg-fd-card p-4 text-left overflow-hidden">
